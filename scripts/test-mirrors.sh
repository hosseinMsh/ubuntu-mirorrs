...
with open("docs/stats.env", "w") as f:
    ...
    fastest_ms = shlex.quote(str(fastest['response_time'] if fastest else 0))
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .refresh-btn { background: var(--blue); color: #fff; border: none; padding: 10px 18px; border-radius: 8px; cursor: pointer; font-size: 0.9em; }
...
<body>
  <div class="container">
    ...
    <footer>
      <p>طراحی شده با ❤️ توسط <a href="https://github.com/hosseinit1988" target="_blank">Hossein.IT</a></p>
